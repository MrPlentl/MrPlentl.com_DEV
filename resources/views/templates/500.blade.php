				...
				<div class="container align-vertical">
					<div class="row">
						<div class="col-sm-12 text-center">
							<i class="icon icon-hourglass icon-large"></i>
							<h1 class="jumbo">500</h1>
							<h1><strong>Sorry about this, something's gone wrong.</strong><br>We're working to fix this ASAP.</h1>
							<a href="chooser" class="btn btn-primary btn-white" target="default">Take Me Home</a>
