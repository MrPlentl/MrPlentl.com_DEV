				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<span class="text-white alt-font">web, print, branding&nbsp;</span>
							<h1 class="text-white">Our Services</h1>
							<p class="lead text-white">Learn how we became an industry icon<br> known for consistent quality</p>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			</header>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6 align-vertical no-align-mobile">
							<h1>Advertise product features simply and elegantly with Kyber</h1>
					...
					<div class="row clearfix pricing-tables">
						...
						<div class="col-md-3  col-sm-6 no-pad">
							<div class="pricing-table emphasis">
								...
								<ul class="features">
									<li><strong>400GB</strong> Storage</li>
									<li><strong>Unlimited</strong> Bandwidth</li>
									<li><strong>24/7</strong> Support</li>
									<li><strong>100</strong> Unique Logins</li>
								</ul>
