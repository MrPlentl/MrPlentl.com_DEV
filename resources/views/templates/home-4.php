    ...
    <body>
		...
		<div class="main-container">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							<h1 class="text-white space-bottom-medium">A small studio in San Jose, CA<br>making badass websites and killer apps.</h1>
			...
			<section class="team-1">
				<div class="container">
					...
					<div class="row space-bottom-large">
						...
						<div class="col-sm-4">
							<div class="team-1-member">
								<img alt="Team Member" src="/img/team-small-4.png">
								<h2>Robin Banks</h2>
								<h5>Partner &amp; COO</h5>
								<p class="space-top-small">
									Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
							<h1 class="text-white">I'm ready to purchase this stunningly beautiful template. Where do I sign?</h1>
							<h2 class="text-white">We're chuffed to hear it, and you'll be chuffed at the incredibly reasonable price.</h2>
							<a href="#" class="btn btn-primary btn-white">More Features</a>
							<a href="#" class="btn btn-primary btn-white btn-filled">Purchase Kyber Crystals</a>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			...
			<section class="instagram-feed">
				...
				<div class="instafeed" data-user-name="grainandmortar">
					<ul></ul>
				</div>
			</section>
