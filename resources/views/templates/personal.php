...
<html class="no-js"> <!--<![endif]-->
    ...
    <body>
		...
		<div class="nav-container"><nav class="top-bar overlay-bar offscreen-menu">
				<div class="container">
					...
					<div class="row nav-menu clearfix">
						...
						<div class="col-sm-2 text-right pull-right col-xs-6">
		...
		<a id="home" class="in-page-link"></a>
			<header class="header-icons overlay">
					<div class="background-image-holder parallax-background">
						<img class="background-image" alt="Background Image" src="/img/hero15.jpg">
					</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<h1 class="text-white">
									Hello, I'm Craig Garner<br>
									A <strong>multi-disciplinary</strong> designer
								</h1>
							</div>
						</div><!--end of row-->
						...
						<div class="row">
							...
							<div class="col-sm-4">
								...
								<h2 class="text-white">Branding &amp; Identity</h2>
							</div>
						</div><!--end of row-->
				...
				<div class="container">
					<div class="row clearfix">
						<div class="col-sm-3 col-xs-12 pull-left">
							<a href="#" class="btn btn-primary btn-grey">contact me</a>
						</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
							<h1>I make sweet websites &amp; killer apps<br />that communicate with clarity + purpose</h1>
						</div>
					</div><!--end of row-->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
							<h1>Check out some of my<br>latest and greatest projects</h1>
							<p class="lead">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<p class="lead">Some awesome companies I've had the pleasure to work with</p>
						</div>
					</div><!--end of row-->
			...
			<section class="instagram-feed">
				...
				<div class="instafeed" data-user-name="focuslabllc">
					<ul></ul>
				</div>
			</section>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 text-center">
							<span class="sub alt-font">I AM CURRENTLY accepting clients</span>
							<h1><strong>I'm located in Melbourne, Australia<br> and I work with clients globally.</strong></h1>
			...
			<footer class="bg-primary short-2">
				...
				<div class="contact-action">
					<div class="align-vertical" style="padding-top: 80px;">
						...
						<a href="/templates/contact" class="text-white"><span class="text-white">Get in touch with me&nbsp;<i class="icon arrow_right"></i></span></a>
					</div>
				</div>
			</footer>
		</div>
