				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							<h1 class="text-white space-bottom-medium">Delivering sound financial advice<br>to everyday investors since 1988.</h1>
			...
			<section class="no-pad clearfix">
				...
				<div class="col-md-6 col-sm-12 no-pad">
					...
					<div class="feature-box">
						...
						<div class="inner">
							<span class="alt-font text-white">Kyber Stands Out</span>
