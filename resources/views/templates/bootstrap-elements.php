...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Kyber | Bootstrap Elements</title>
		...
		<div class="main-container">
			<header class="page-header">
				<div class="background-image-holder parallax-background">
					<img class="background-image" alt="Background Image" src="https://unsplash.imgix.net/45/QDSMoAMTYaZoXpcwBjsL__DSC0104-1.jpg?q=75&fm=jpg&auto=format&s=712c9b9c7ff4ea566d61e7f4bbe6cc53">
				</div>
				
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<span class="text-white alt-font">Styled Elements</span>
							<h1 class="text-white">Bootstrap Elements</h1>
							<p class="text-white lead">Experience all the goodness of Bootstrap<br />with the ease and flexibility of an<br />awesome page builder.</p>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			</header>
