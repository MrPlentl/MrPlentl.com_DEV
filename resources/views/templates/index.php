...
<html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Kyber - Multipurpose HTML Template</title>
				...
				<div class="container align-vertical">
					<div class="row">
						<div class="col-md-12 text-center">
							<span class="text-white alt-font">DISCOVER Kyber TODAY</span>
							...
							<a target="_blank" href="#" class="btn btn-primary btn-white">Customize Kyber</a>
							<a href="http://themeforest.net/item/Kyber-responsive-multipurpose-html-with-builder-v141/8748103" class="btn btn-primary btn-filled" target="_blank">Purchase Kyber Crystals</a>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			</header>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 text-center">
							...
							<h1><strong>Learn why over 1,600 people love Kyber</strong></h1>
							<p class="lead">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-offset-6 col-sm-7 col-sm-offset-5 content clearfix">
							<h1>Kyber includes many element<br>variations to showcase your content.</h1>
							<p class="lead">
								...
								<div class="col-md-6 no-pad-left">
									<div class="feature feature-icon-left">
										...
										<div class="feature-text">
											...
											<p>
												Both Variant and Kyber come with clear concise docs written in plain English.</p>
										</div>
									</div>
								</div><!--end of feature-->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<h1 class="space-bottom-medium">Kyber + Variant make building your landing page a breeze.</h1>
					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<div class="testimonials-slider text-center">
								<ul class="slides">
									<li>
										<p class="text-white lead">Kyber is hands down the most flexible and enjoyable HTML template I've ever used. I was a startup framework die-hard but now my eyes have been opened to the sheer power of Variant page builder, I won't be going back!</p>
										<span class="author text-white">Louise Duke - Mother Goose</span>
									</li>
									
									<li>
										<p class="text-white lead">I was getting fed up with the hassle of setting up bloated WordPress themes. Luckily I've now found Kyber with Variant. Building pages in real-time without a CMS gives me all the power and flexibility I could want.</p>
										<span class="author text-white">Elizabeth Atkinson - Shapewear Australia</span>
									</li>
									
									<li>
										<p class="text-white lead">The plethora of content blocks available in Kyber has made it my go-to template of choice. I've already used it for a number of clients - all of which have been thrilled with the outcome. Well done Medium Rare!</p>
				...
				<div class="container">
					<div class="row clearfix">
						<div class="col-sm-6 col-xs-12 pull-left">
							<h3 class="text-white"><strong>Purchase Kyber Crystals.</strong>&nbsp;Start building today.</h3>
						</div>
						
						<div class="col-sm-4 col-xs-12 pull-right text-right">
							<a href="http://themeforest.net/item/Kyber-responsive-multipurpose-html-with-builder-v141/8748103" class="btn btn-primary btn-white" target="_blank">Purchase Kyber Crystals</a>
						</div>
					</div>
				</div>
			</section>
