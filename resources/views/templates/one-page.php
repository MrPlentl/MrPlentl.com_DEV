...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Kyber Multipurpose Template</title>
				...
				<div class="container align-vertical">
					<div class="row">
						<div class="col-md-12 text-center">
							<span class="text-white alt-font">Say Hello To Kyber</span>
							...
							<a href="#" class="btn btn-primary btn-filled">Purchase Kyber Crystals</a>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			</header>
				...
				<div class="container">
					<div class="row">
						<div class="text-center col-sm-11">
							...
							<h1 class="text-white">"We were blown away by the team at Kyber,<div>all our expectations were exceeded."</div></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<h1 class="space-bottom-medium">Kyber is an effortlessly simple startup template with usable features.</h1>
