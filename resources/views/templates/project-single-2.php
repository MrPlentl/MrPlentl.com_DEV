				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
							<h1 class="text-white">We were tasked with rebranding this<br>budding non-profit startup</h1>
							<h2 class="text-white">Branding, Identity, Web Design</h2>
							<a href="#" class="btn btn-primary btn-white">view project</a>
