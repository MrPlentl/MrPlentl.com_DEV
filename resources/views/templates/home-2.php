				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-6 col-md-offset-6 col-sm-8 col-sm-offset-4 content clearfix">
							...
							<a href="" class="btn btn-primary">Purchase Kyber Crystals</a><br>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 content col-sm-8 clearfix">
							<h1>Keep up with the latest happenings</h1>
			...
			<section class="no-pad clearfix">
				...
				<div class="col-md-6 col-sm-12 no-pad">
					...
					<div class="feature-box">
						...
						<div class="inner">
							<span class="alt-font text-white">study advice</span>
							<h1 class="text-white">Planning the perfect gap year travel experience.</h1>
							<p class="text-white">
				...
				<div class="col-md-6 col-sm-12 no-pad">
					...
					<div class="feature-box">
						...
						<div class="inner">
							<span class="alt-font text-white">back to uni</span>
							<h1 class="text-white">An uncluttered desk means a clear, productive mind.</h1>
							<p class="text-white">
								Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. 
							</p>
							<a href="#" class="btn btn-primary btn-white">Tell Me More</a>
